    ...
    class Program
    {
        ...
        public class LinqSamples
        {
            ...
            public void Linq3()
            {
                ...
                var expensiveInStockProducts = from product in products
                                               where product.UnitsInStock != 0 && product.UnitPrice.CompareTo(3.00M) > 0
                                               select product;
            ...
            public void Linq4()
            {
                ...
                var waCustomers = from customer in customers
                                  where String.Equals(customer.Region, "WA")
                                  select customer;
